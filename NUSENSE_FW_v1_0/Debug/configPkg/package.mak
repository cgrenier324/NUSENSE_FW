...
.dlls,em3 .dlls: mutex.pem3

-include package/cfg/mutex_pem3.mak
-include package/cfg/mutex_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/mutex_pem3.dep
endif
mutex.pem3: package/cfg/mutex_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
mutex.pem3 package/cfg/mutex_pem3.c: .libraries,em3
endif

package/cfg/mutex_pem3.c package/cfg/mutex_pem3.h package/cfg/mutex_pem3.xdl: override _PROG_NAME := mutex.xem3
package/cfg/mutex_pem3.c: package/cfg/mutex_pem3.cfg
package/cfg/mutex_pem3.xdc.inc: package/cfg/mutex_pem3.xdl
package/cfg/mutex_pem3.xdl package/cfg/mutex_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/mutex_pem3.cfg
	-$(RM) package/cfg/mutex_pem3.dep
	-$(RM) package/cfg/mutex_pem3.c
	-$(RM) package/cfg/mutex_pem3.xdc.inc

clean,em3::
	-$(RM) mutex.pem3
.executables,em3 .executables: mutex.xem3

mutex.xem3: |mutex.pem3

-include package/cfg/mutex.xem3.mak
mutex.xem3: package/cfg/mutex_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/mutex_pem3.oem3   package/cfg/mutex_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
mutex.xem3: export C_DIR=
mutex.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
mutex.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

mutex.test test,em3 test: mutex.xem3.test

mutex.xem3.test:: mutex.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 mutex.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.mutex.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,mutex.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
mutex_pem3.oem3,copy : package/cfg/mutex_pem3.oem3
mutex_pem3.sem3,copy : package/cfg/mutex_pem3.sem3
